...
case class TankerDetails(name: String, accountId: Int, clanId: String, battles: Int, wins: Int, avgTier: Double, avgSpot: Double, avgFrags: Double, wn8: Double, tanks: Seq[TankStats]) {
