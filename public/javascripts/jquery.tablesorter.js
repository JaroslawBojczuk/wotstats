        ...
        function () {
            ...
            function multisort(table, sortList, cache) {
                ...
                for (var i = 0; i < l; i++) {
                    ...
                    var s = (table.config.parsers[c].type == "text") ? ((order == 0) ? makeSortFunction("text", "asc", c) : makeSortFunction("text", "desc", c)) : ((order == 0) ? makeSortFunction("numeric", "desc", c) : makeSortFunction("numeric", "asc", c));
                    var e = "e" + i;
